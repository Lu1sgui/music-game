"use strict";(()=>{var e={};e.id=9118,e.ids=[9118],e.modules={3524:e=>{e.exports=require("@prisma/client")},399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},4770:e=>{e.exports=require("crypto")},7366:(e,t,r)=>{r.r(t),r.d(t,{originalPathname:()=>f,patchFetch:()=>x,requestAsyncStorage:()=>c,routeModule:()=>m,serverHooks:()=>y,staticGenerationAsyncStorage:()=>g});var o={};r.r(o),r.d(o,{POST:()=>h});var s=r(9303),a=r(8716),i=r(670),n=r(7070),p=r(4770),l=r(2331),d=r(6119),u=r(5062);async function h(e){try{let{email:t}=await e.json();if(!t)return n.NextResponse.json({error:"Email required"},{status:400});let r=String(t).toLowerCase().trim(),o=(0,u.h)(`forgot:${r}`,3,36e5),s=(0,u.h)(`forgot-ip:${(0,u.j)(e)}`,10,36e5);if(!o.ok||!s.ok)return n.NextResponse.json({message:"If an account exists with that email, a password reset link has been sent."});let a=await l._.user.findFirst({where:{email:{equals:r,mode:"insensitive"}}});if(a){await l._.passwordReset.updateMany({where:{userId:a.id,usedAt:null},data:{usedAt:new Date}});let e=(0,p.randomBytes)(32).toString("base64url"),t=(0,p.createHash)("sha256").update(e).digest("hex"),r=new Date(Date.now()+36e5);await l._.passwordReset.create({data:{userId:a.id,tokenHash:t,expiresAt:r}});let o=`https://devinsmusic.reviews/reset-password/${e}`;await (0,d.Cz)({to:a.email,subject:"⚡ Reset your Weekly Beats password",html:(0,d.oe)(a.username,o)})}return n.NextResponse.json({message:"If an account exists with that email, a password reset link has been sent."})}catch(e){return console.error("[POST /api/auth/forgot-password]",e?.message??e),n.NextResponse.json({error:"Internal server error"},{status:500})}}let m=new s.AppRouteRouteModule({definition:{kind:a.x.APP_ROUTE,page:"/api/auth/forgot-password/route",pathname:"/api/auth/forgot-password",filename:"route",bundlePath:"app/api/auth/forgot-password/route"},resolvedPagePath:"/Users/luisgui/music-game/app/api/auth/forgot-password/route.ts",nextConfigOutput:"",userland:o}),{requestAsyncStorage:c,staticGenerationAsyncStorage:g,serverHooks:y}=m,f="/api/auth/forgot-password/route";function x(){return(0,i.patchFetch)({serverHooks:y,staticGenerationAsyncStorage:g})}},6119:(e,t,r)=>{async function o({to:e,subject:t,html:r}){let o=process.env.RESEND_API_KEY,s=process.env.EMAIL_FROM??"Weekly Beats <onboarding@resend.dev>";if(!o)return console.warn("[email] RESEND_API_KEY not set — skipping email send"),!1;try{let a=await fetch("https://api.resend.com/emails",{method:"POST",headers:{Authorization:`Bearer ${o}`,"Content-Type":"application/json"},body:JSON.stringify({from:s,to:e,subject:t,html:r})});if(!a.ok){let e=await a.text();return console.error("[email] Resend error:",a.status,e),!1}return!0}catch(e){return console.error("[email] Send failed:",e),!1}}function s(e,t){return`
<!DOCTYPE html>
<html>
...
<body style="margin:0; padding:0; background:#0E1228; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif;">
  ...
  `.trim()}function a(e,t,r){var o;return o=`
