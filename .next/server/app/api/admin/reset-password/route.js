"use strict";(()=>{var e={};e.id=3682,e.ids=[3682],e.modules={3524:e=>{e.exports=require("@prisma/client")},399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},8893:e=>{e.exports=require("buffer")},4770:e=>{e.exports=require("crypto")},6162:e=>{e.exports=require("stream")},1764:e=>{e.exports=require("util")},2085:(e,r,t)=>{t.r(r),t.d(r,{originalPathname:()=>x,patchFetch:()=>w,requestAsyncStorage:()=>y,routeModule:()=>h,serverHooks:()=>g,staticGenerationAsyncStorage:()=>f});var s={};t.r(s),t.d(s,{POST:()=>m});var o=t(9303),n=t(8716),a=t(670),i=t(7070),p=t(4770),l=t(2331),d=t(9178),u=t(6119),c=t(8867);async function m(e){try{let r=(0,d.z3)(e);if(!r)return i.NextResponse.json({error:"Unauthorized"},{status:401});if("ADMIN"!==r.role)return i.NextResponse.json({error:"Forbidden"},{status:403});let{userId:t}=await e.json();if(!t)return i.NextResponse.json({error:"userId required"},{status:400});let s=await l._.user.findUnique({where:{id:t}});if(!s)return i.NextResponse.json({error:"User not found"},{status:404});let o=function(){let e="abcdefghjkmnpqrstuvwxyzABCDEFGHJKMNPQRSTUVWXYZ23456789",r="";for(let t=0;t<12;t++)r+=e[(0,p.randomInt)(e.length)];return r}(),n=await (0,d.c_)(o);return await l._.user.update({where:{id:s.id},data:{passwordHash:n,mustChangePassword:!0}}),await (0,u.Cz)({to:s.email,subject:"⚡ Your Weekly Beats password was reset",html:(0,u.CL)(s.username,o)}),await (0,c.b)(s.id,`🔑 Your password was reset by an admin. Check your email for the temporary password.`),i.NextResponse.json({message:`Password reset for @${s.username}`,tempPassword:o,emailSentTo:s.email})}catch(e){return console.error("[POST /api/admin/reset-password]",e?.message??e),i.NextResponse.json({error:"Internal server error"},{status:500})}}let h=new o.AppRouteRouteModule({definition:{kind:n.x.APP_ROUTE,page:"/api/admin/reset-password/route",pathname:"/api/admin/reset-password",filename:"route",bundlePath:"app/api/admin/reset-password/route"},resolvedPagePath:"/Users/luisgui/music-game/app/api/admin/reset-password/route.ts",nextConfigOutput:"",userland:s}),{requestAsyncStorage:y,staticGenerationAsyncStorage:f,serverHooks:g}=h,x="/api/admin/reset-password/route";function w(){return(0,a.patchFetch)({serverHooks:g,staticGenerationAsyncStorage:f})}},9178:(e,r,t)=>{t.d(r,{Oe:()=>l,c_:()=>p,fT:()=>d,z3:()=>u});var s=t(1482),o=t.n(s),n=t(2023),a=t.n(n);let i=process.env.JWT_SECRET;if(!i)throw Error("JWT_SECRET environment variable is not set");async function p(e){return a().hash(e,12)}async function l(e,r){return a().compare(e,r)}function d(e){return o().sign(e,i,{expiresIn:"7d"})}function u(e){let r=function(e,r){if(e?.startsWith("Bearer "))return e.slice(7);if(r){let e=r.match(/(?:^|;\s*)token=([^;]+)/);return e?e[1]:null}return null}(e.headers.get("authorization"),e.headers.get("cookie"));if(!r)return null;try{return o().verify(r,i)}catch{return null}}},6119:(e,r,t)=>{async function s({to:e,subject:r,html:t}){let s=process.env.RESEND_API_KEY,o=process.env.EMAIL_FROM??"Weekly Beats <onboarding@resend.dev>";if(!s)return console.warn("[email] RESEND_API_KEY not set — skipping email send"),!1;try{let n=await fetch("https://api.resend.com/emails",{method:"POST",headers:{Authorization:`Bearer ${s}`,"Content-Type":"application/json"},body:JSON.stringify({from:o,to:e,subject:r,html:t})});if(!n.ok){let e=await n.text();return console.error("[email] Resend error:",n.status,e),!1}return!0}catch(e){return console.error("[email] Send failed:",e),!1}}function o(e,r){return`
<!DOCTYPE html>
<html>
